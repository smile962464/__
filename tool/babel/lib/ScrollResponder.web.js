...
let ScrollResponderMixin = {
   ...
   */
  scrollResponderHandleMoveShouldSetResponderCapture: function (e) {
    return true;
  },
  ...
  scrollResponderIsAnimating: function () {
    ...
    let isAnimating = timeSinceLastMomentumScrollEnd < IS_ANIMATING_TOUCH_START_THRESHOLD_MS || this.state.lastMomentumScrollEndTime < this.state.lastMomentumScrollBeginTime;
    return isAnimating;
  },
  ...
  scrollResponderInputMeasureAndScrollToKeyboard: function (left, top, width, height) {
    if (this.keyboardWillOpenTo) {
      let scrollOffsetY = top - this.keyboardWillOpenTo.endCoordinates.screenY + height + this.additionalScrollOffset;
